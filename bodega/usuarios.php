  ...
  <body>
    ...
    <div class="container-fluid">
		...
		<div class="jumbotron jumbotron-fluid"" >
		    <div class="container">
			<h4><i class='fas fa-search'></i> Consultar Usuarios</h4>
				<hr class="my-4">
				<button type='button' class="btn btn-success" data-toggle="modal" data-target="#myModal"><span class="fas fa-plus" ></span> Nuevo Usuario</button>
			</div>
		</div>			
