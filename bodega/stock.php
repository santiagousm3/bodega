  ...
  <body>
    ...
    <div class="container-fluid">
		<div class="jumbotron jumbotron-fluid"" >
		    <div class="container">
				<h4><i class='fas fa-search'></i> Consultar inventario</h4>
				<hr class="my-4">
				<button type='button' class="btn btn-success" data-toggle="modal" data-target="#nuevoProducto"><span class="fas fa-plus" ></span> Agregar</button>
			</div>
		</div>
